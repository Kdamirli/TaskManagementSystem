...
{
    public partial class DirectorLog : Form
    {
        Func func = new Func();
        String query;
        public DirectorLog()
        ...
        private void btnLog_Click(object sender, EventArgs e)
        {
            if (tbPassword.Text != "" && tbLogin.Text != "")
            {
                ...
                {
                    MessageBox.Show("Руководителя не существует!", "Внимание", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            else
            {
        ...
        {
            DirectorReg reg = new DirectorReg();
            this.Hide();
            reg.Show();
        }
    }
